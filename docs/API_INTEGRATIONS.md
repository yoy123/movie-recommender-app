...
**Security Risk:** Debug builds vulnerable to MITM attacks. Never ship debug builds.
...
No explicit configuration; Coil handles caching automatically.
...
5. Exclusion list
6. Hard constraint: **"ONLY select from the candidate list"**
...
**Code:** [LlmRecommendationService.kt:75](../app/src/main/java/com/movierecommender/app/data/remote/LlmRecommendationService.kt#L75)
...
### Usage
**Repository Method:** `MovieRepository.getImdbRating(title, year)`  
**Implementation:** Returns `null` immediately (hardcoded)

**Code:** [MovieRepository.kt:1025](../app/src/main/java/com/movierecommender/app/data/repository/MovieRepository.kt#L1025)
```kotlin
...
**Reason:** UI displays TMDB ratings instead (`movie.voteAverage`).
